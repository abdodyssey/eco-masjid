    ...
    <section className="bg-emerald-800 text-white py-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl leading-relaxed text-white/90 max-w-2xl mx-auto">
          <strong>EcoMasjid</strong> adalah platform digital yang mendorong
          masjid untuk menerapkan prinsip ramah lingkungan berdasarkan ajaran
          Islam. Kami percaya bahwa masjid bisa menjadi pusat edukasi dan aksi
